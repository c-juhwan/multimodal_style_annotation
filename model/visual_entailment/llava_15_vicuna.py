...
class LLaVA15VicunaVEModel(nn.Module):
    def __init__(self, args: argparse.Namespace) -> None:
        super(LLaVA15VicunaVEModel, self).__init__()
        self.args = args
    ...
    def generate(self, image, premise, hypothesis):
        ...
        prompt_input = [f"USER: <image>\nStatement: {each_hypothesis}\nDetermine if the statement is true, false, or undetermined based on the image. Answer with true, false, or undetermined. ASSISTANT:" for each_hypothesis in hypothesis]

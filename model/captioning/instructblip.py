...
class InstructBlipCaptioningModel(nn.Module):
    def __init__(self, args: argparse.Namespace) -> None:
        super(InstructBlipCaptioningModel, self).__init__()
        self.args = args
    ...
    def generate(self, image):
        ...
        generated_text = self.processor.tokenizer.batch_decode(generated_outputs, skip_special_tokens=True)[0]
